...
//        }
     ...
     *
     * Every request variable is validated or escaped before it goes into the SVG, which is served as
     * image/svg+xml from the CMS origin. Invalid values fall back to the `default_placeholder` config.
     *
     * @param $request
     * @return void
     */
